...
import com.beautyyan.beautyyanapp.listener.ImageGestureListener;
import com.beautyyan.beautyyanapp.view.MultiTouchZoomableImageView;
...
public class ShowPicActivitiy extends Activity{
    ...
    private MultiTouchZoomableImageView imageView;
...
//                WindowManager.LayoutParams. FLAG_FULLSCREEN);
        ...
        imageView = (MultiTouchZoomableImageView) findViewById(R.id.myImageView);
        ...
        if (path.contains("http")) {
            Picasso.with(ShowPicActivitiy.this)
                    .load(path)
                    .into(new Target() {
                        @Override
...
//        });
    ...
    @Override
    public void finish() {
        imageView.setBackgroundColor(getResources().getColor(R.color.no_color));
        ChatActivity.getIns().setViewBgGone(true);
        super.finish();
        overridePendingTransition(R.anim.do_nothing, R.anim.zoom_exit);
    }
