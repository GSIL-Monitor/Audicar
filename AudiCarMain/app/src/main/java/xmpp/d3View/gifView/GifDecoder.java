...
//      }
        ...
        /**
         * �����Ƿ�Ҫ����ͼƬ<br>
         * ������Ҫ����ͼƬʱ�����������ͼƬ��ֱ��д���ļ��У������������ڴ��У�����ʱ�����Sd������ֱ�ӻ��浽sd���У����û����Ỻ�浽��ǰapk�µ��ļ�Ŀ¼��<br>
         * <b>�����������Ŀ¼ʧ�ܣ����Զ��л�Ϊ������</b><br>
         * Ĭ�ϲ�����
         * @param cache �Ƿ�Ҫ���棬trueҪ����
         * @param context
         */
        public void setCacheImage(boolean cache,Context context){
            ...
            try{
                ...
                if(Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)){
                        imagePath = Environment.getExternalStorageDirectory().getPath() + File.separator + "gifView_tmp_dir" + File.separator + getDir();
        ...
        public void run(){
                if(in != null && !isDestroy){
                        readStream();
                }else if(gifData != null && !isDestroy){
                        readByte();
                }
        }
